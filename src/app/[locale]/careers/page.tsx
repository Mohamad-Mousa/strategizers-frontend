...
export async function generateMetadata({
  ...
  const seo = websiteData?.careerPage?.seo;
...
export default async function CareersPage({
  ...
  const bannerUrl = websiteData?.careerPage?.banner
    ? `https://api-strat.othmanconstruction.com/${websiteData.careerPage.banner}`
    : "/services.webp";
  ...
  return (
    <div className="flex flex-col gap-10 items-center justify-center">
      ...
      {/* Careers Content - Client Component */}
      <CareersContent />
    </div>
  );
}
