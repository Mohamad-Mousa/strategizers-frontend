    ...
    <div className="flex flex-col">
      ...
      <section className="max-w-7xl mx-auto mt-20 px-6 flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            {getLocalizedText(project.projectAnalysis.description)}
          </p>
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            {getLocalizedText(project.projectSolutions.description)}
          </p>
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            {getLocalizedText(project.projectResults.description)}
          </p>
