...
export async function generateMetadata({
  ...
  const seo = websiteData?.projectPage?.seo;
...
export default async function SuccessStoriesPage({
  ...
  const bannerUrl = websiteData?.projectPage?.banner
    ? `https://api-strat.othmanconstruction.com/${websiteData.projectPage.banner}`
    : "/services.webp";
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Stories Content - Client Component */}
      <StoriesContent />
    </div>
  );
}
