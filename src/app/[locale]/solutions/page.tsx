...
export async function generateMetadata({
  ...
  const seo = websiteData?.servicePage?.seo;
...
export default async function SolutionsPage({
  ...
  const bannerUrl = websiteData?.servicePage?.banner
    ? `https://api-strat.othmanconstruction.com/${websiteData.servicePage.banner}`
    : "/services.webp";
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Solutions Content - Client Component */}
      <SolutionsContent />
    </div>
  );
}
